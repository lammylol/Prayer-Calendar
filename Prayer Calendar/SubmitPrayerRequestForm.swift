...
struct SubmitPrayerRequestForm: View {
    ...
    func submitList() {
        PrayerRequestHelper().addPrayerRequest(username: userHolder.person.username, firstName: firstName, lastName: lastName, prayerRequestText: prayerRequestText, priority: priority)
