...
struct SubmitPrayerRequestForm: View {
    ...
    func submitList() {
        PrayerRequestHelper().addPrayerRequest(userID: userHolder.userID, firstName: firstName, lastName: lastName, prayerRequestText: prayerRequestText, priority: priority)
